...
digits, you would throw an OCRException runtime exception. 
...
You may create additional classes or other private methods in
OCRTranslator to help you solve this problem. You **may not** modify the
signature of `translate()`. There are some additional instructions in the 
